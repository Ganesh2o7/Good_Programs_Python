...
class_index = (1000, 2000)  # Selecting class3 examples

X_train, X_test, Y_train, Y_test = load_dataset(dataset_path, class_index)
...
# Visualization
plot_data(X_train, Y_train, X_test, Y_test, dataset_name="Class 3")
